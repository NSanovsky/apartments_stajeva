...
<meta charset="UTF-8"> 
  ...
  <title>Apartments Stajeva Dubrovnik - Torquise Lavander 2 Bedroom App</title>
</head>
<body>
  ...
  <div class="naslov_ap">
       ...
       <h3>TOURQUOISE LAVANDER <br> COZY 2 BEDROOM APARTMENT</h3>
    </div>
    <div class="mosaic">
     
       <p class="size"> Apartment size: 45 m² <br></p>
       <p class="opisi">
      ...
      <div class="read-more"><a class=" pulse waves-effect waves-light  btn btn-large " href="https://booking.rentl.io/en/12860/dcbb0531-413f-4f5d-b8b9-d903861de169">BOOK NOW</a></div>
